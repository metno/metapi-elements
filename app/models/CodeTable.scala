...
@ApiModel(description="Data response for code table metadata.")
case class CodeTableResponse(
  ...
  @(ApiModelProperty @field)(name=ApiConstants.OBJECT_TYPE_NAME, value=ApiConstants.OBJECT_TYPE, example="CodeTableResponse") responseType: String,
  ...
  @(ApiModelProperty @field)(value=ApiConstants.DATA) data: Seq[CodeTable]
)
...
@ApiModel(description="Metadata for a single code table.")
...
case class CodeTableValue(
  @(ApiModelProperty @field)(value="The code table value.", example="10") value: String,
  @(ApiModelProperty @field)(value="The main description.") description: Option[String],
  @(ApiModelProperty @field)(value="Additional info.") additionalInfo: Option[String]
)

...
@ApiModel(description="Data response for calculation method function metadata.")
case class CalcMethodFunctionResponse(
  ...
  @(ApiModelProperty @field)(value=ApiConstants.DATA) data: Seq[CalcMethodFunction]
)
...
@ApiModel(description="The function of a calculation method.")
case class CalcMethodFunction(
  @(ApiModelProperty @field)(value="The function.", example="from_direction_of_max") function: Option[String],
  @(ApiModelProperty @field)(value="The unit.", example="degrees") unit: Option[String],
  @(ApiModelProperty @field)(value="The description.") description: Option[String]
)

...
update element_description set description='Weather at time of observation, code (number or letter) for different types of weather, up to three codes may be given (V1-V3).' where description_locale='en_US' and element_id='precipitation_type_tertiary_significance';
update element_description set description='Weather during six or twelve hours before time of observation, code (number or letter) for different types of weather, up to four codes may be given (V4-V7)' where description_locale='en_US' and element_id='over_time(precipitation_type_primary_significance PT6H)';
update element_description set description='Weather at time of observation, code (number or letter) for different types of weather, up to three codes may be given (V1-V3).' where description_locale='en_US' and element_id='precipitation_type_primary_significance';
update element_description set description='Weather during six or twelve hours before time of observation, code (number or letter) for different types of weather, up to four codes may be given (V4-V7)' where description_locale='en_US' and element_id='over_time(precipitation_type_secondary_significance PT6H)';
update element_description set description='Weather during six or twelve hours before time of observation, code (number or letter) for different types of weather, up to four codes may be given (V4-V7)' where description_locale='en_US' and element_id='over_time(precipitation_type_secondary_significance P1D)';
update element_description set description='Weather during six or twelve hours before time of observation, code (number or letter) for different types of weather, up to four codes may be given (V4-V7)' where description_locale='en_US' and element_id='precipitation_type_quaternary_significance';
update element_description set description='Snow depth, total from ground up, normally measured in the morning. Code = -1 means no snow, presented as ".", -3 = "not possible to measure".' where description_locale='en_US' and element_id='surface_snow_thickness';
update element_description set description='Weather at time of observation, code (number or letter) for different types of weather, up to three codes may be given (V1-V3).' where description_locale='en_US' and element_id='precipitation_type_secondary_significance';
update element_description set description='Weather during six or twelve hours before time of observation, code (number or letter) for different types of weather, up to four codes may be given (V4-V7)' where description_locale='en_US' and element_id='over_time(precipitation_type_tertiary_significance PT6H)';
update element_description set description='Weather during six or twelve hours before time of observation, code (number or letter) for different types of weather, up to four codes may be given (V4-V7)' where description_locale='en_US' and element_id='over_time(precipitation_type_tertiary_significance P1D)';
